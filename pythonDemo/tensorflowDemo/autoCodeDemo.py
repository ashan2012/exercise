...
autoencoder = AdditiveGaussianNoiseAutoEncoder(n_input=784,n_hidden=20,transfer_function=tf.nn.softplus,optimizer=tf.train.AdadeltaOptimizer(learning_rate=0.001),scale= 0.01)
